...
CREATE TABLE IF NOT EXISTS efficiency(
    users_id BIGSERIAL PRIMARY KEY REFERENCES users(id),  --TODO: поправить связь onetoone ВЕЗДЕ
...
CREATE TABLE IF NOT EXISTS criteria_bonus_for_fur( --TODO: поправить выравнивание
    id BIGSERIAL PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXISTS fur_result(
    users_id BIGSERIAL PRIMARY KEY REFERENCES users(id),
    bonus NUMERIC NOT NULL,
