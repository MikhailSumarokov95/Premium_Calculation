...
VALUES
('Бытовая техника и электроника', 0.002, 30, 3000, 'POINT_OF_SALE', 0),
('Мебель, Меха и одежда', 0.0009, 30, 3000, 'POINT_OF_SALE', 0),
('Мобильные телефоны и Ювелирные изделия', 0.0006, 30, 1300, 'POINT_OF_SALE', 0),
('Общая мотивация', 0.0013, 30, 3000, 'POINT_OF_SALE', 0),
('Стройматериалы и Мототехника', 0.0013, 30, 3000, 'POINT_OF_SALE', 0),
('Услуги', 0.0013, 30, 3000, 'POINT_OF_SALE', 0),
('Наличные на карту тип с 1 по 3', 0.006, 0, 6000, 'CASH_ON_CARD', 100000),
('Наличные на карту тип 4', 0.006, 0, 6000, 'CASH_ON_CARD', 100000);
